...
export default function GroupsPage() {
  ...
  return (
    <div className="p-8">
      ...
      <p className="text-slate-500 text-sm mt-1">Manage groups and their policy assignments</p>
      ...
      {admin && (
        ...
        >
          <h2 className="text-sm font-semibold text-slate-900 mb-4">Create new group</h2>
            ...
            {loading ? (
              ...
              groups.map((group) => (
                <tr key={group.group_id} className="hover:bg-slate-50">
                  <td className="px-6 py-4 text-sm text-slate-900">{group.name}</td>
                  {admin && (
      ...
      >
        {modalLoading ? (
          ...
          <div className="space-y-4">
            ...
            {policies.length === 0 ? (
              <p className="text-sm text-slate-400">No policies available</p>
            ) : (
